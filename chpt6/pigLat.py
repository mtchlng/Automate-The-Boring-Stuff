...
pigLatin = [] #A list of the words in Pig pigLatin
for word in message.split(): #makes a list of words as separate strings
    ...
    if wasUpper: word = word.upper()
    if wasTitle: word = word.title()
